...
API REQUEST PARALLEL PROCESSOR
    originally api_request_parallel_processor.py
...
- max_tok_per_min : float, optional
...
async def process_api_requests_from_file(
    ...
    available_token_capacity = max_tok_per_min
    ...
    with open(requests_filepath) as file:
        ...
        while True:
            ...
            available_token_capacity = min(
                available_token_capacity + max_tok_per_min * seconds_since_update / 60.0,
                max_tok_per_min,
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--request_url", required=True)
    parser.add_argument("--api_key", required=True)
    parser.add_argument("--max_requests_per_minute", type=int, default=100)
    parser.add_argument("--max_tok_per_min", type=int, default=240000)
    parser.add_argument("--token_encoding_name", default="cl100k_base")
    parser.add_argument("--max_attempts", type=int, default=5)
    parser.add_argument("--logging_level", default=20) #logging.INFO)
    ...
    asyncio.run(
        process_api_requests_from_file(
            ...
            max_tok_per_min=float(args.max_tok_per_min),
